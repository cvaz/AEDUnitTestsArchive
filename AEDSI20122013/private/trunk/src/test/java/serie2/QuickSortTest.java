...
public class QuickSortTest {
  ...
  public void quicksort_with_increasingElements(){
	...
	public void quicksort_with_SomeElements1_list(){
	    ...
	    array.add(22);array.add(-30);array.add(-30);
	    array.add(32);array.add(-38);array.add(-34);array.add(-36);
	...
	public void quicksort_with_som2Elements2_list(){
		ArrayList<Integer> array=new ArrayList<Integer>();
		array.add(27);array.add(-12);array.add(33);array.add(27);
		array.add(26);array.add(-33);array.add(14);array.add(26);
		array.add(8);array.add(9);array.add(-19);
		Node<Integer> list=TestListUtil.getListWithoutSentinel(array);
