...
import static serie2.Iterables.concat;
import java.util.*;

public class concatTest extends IterablesTest {
	...
	public void concat_OnEmptySequence(){
		...
		assertIterableEmpty( concat( unmodifiable ( seq ) ) );	
	...
	public void concat_OneSequenceOfOneElementSequence(){
		...
		seq.add( s1 );
		assertIterableEquals( s1, concat( unmodifiable(seq) ) );
	}
	...
	public void concat_TwoSequenceOfOneElement(){
		...
		assertIterableEquals( expected, concat( unmodifiable( seq ) ) );	
	}
	...
	public void concat_TwoSequenceButOneIsEmpty(){
		...
		assertIterableEquals( seq2, concat( unmodifiable ( seq ) ) );
